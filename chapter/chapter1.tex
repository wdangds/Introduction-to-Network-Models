\chapter{Motivation, and introduction to graph theory}\label{ch:motivation-introduction}
...
\input{fig/directed-undirected-graph.tex}
...
\input{fig/simple-multi-graphs.tex}
...
\input{fig/adjacency-incidence.tex}
...
\end{itemize}
\input{fig/degree-directed-graph.tex}
...
\end{definition}
\input{fig/connected-components.tex}
...
\input{fig/weakly-connected-graphs.tex}
...
\input{fig/clique.tex}

\subsubsection{Regular graphs}\label{regular-graphs}
...
\begin{definition}
{Trees and Forests}{trees-forests}
